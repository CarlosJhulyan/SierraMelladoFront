            ...
            <Row gutter={[24,0]}>
              ...
              <Col xl={12} lg={12} md={12} sm={24} xs={24} className='mb-24'>
                <Descriptions title={`Detalles de orden # ${String(detailsDate.numOrden).padStart(9, '0')}`}>
                  ...
                  <Descriptions.Item span={2} label='Estado'>
              ...
              <Col xl={12} lg={12} md={12} sm={24} xs={24} className='mb-24'>
                <Descriptions title='Detalles de médico'>
                  <Descriptions.Item span={3} label='Médico'>
                    {detailsDate.nombresM} {detailsDate.apPaternoM} {detailsDate.apMaternoM}
                  </Descriptions.Item>
                  <Descriptions.Item span={3} label='Correo'>
                    {detailsDate.correoM}
                  </Descriptions.Item>
                  <Descriptions.Item span={2} label='Celular'>
                    (+51) {detailsDate.celularM}
                  </Descriptions.Item>
                  <Descriptions.Item span={1} label='DNI'>
                    {detailsDate.dniM}
                  </Descriptions.Item>
                  <Descriptions.Item span={2} label='Fecha nacimiento'>
                    {moment(detailsDate.fechaNacM).format('ll')}
                  </Descriptions.Item>
                  <Descriptions.Item span={1} label='CMP'>
                    {detailsDate.codColegiadoM}
                  </Descriptions.Item>
                </Descriptions>
              </Col>
              <Col xl={12} lg={12} md={12} sm={24} xs={24} className='mb-24'>
                <Descriptions title='Detalles de paciente'>
                  ...
                  <Descriptions.Item span={2} label='Fecha nacimiento'>
                    {moment(detailsDate.fechaNacP).format('ll')}
                  </Descriptions.Item>
                </Descriptions>
              </Col>
            </Row>
